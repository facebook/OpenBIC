...
aspeed_i2c_priv_t i2c0_priv = {.parent = &i2c_global, .bus_clk = 400000, .irq = I2c0_IRQn, .buff_addr = I2C0_BUFF_BASE};
DECLARE_DEV_CLK(i2c0, 0, 0, 0);
DECLARE_DEV_RESET(i2c0, 0, 0, 0);
DECLARE_DEV(i2c0, ASPEED_DEV_I2C0, I2C0_BASE, &i2c0_priv);

aspeed_i2c_priv_t i2c1_priv = {.parent = &i2c_global, .bus_clk = 400000, .irq = I2c1_IRQn, .buff_addr = I2C1_BUFF_BASE};
DECLARE_DEV_CLK(i2c1, 0, 0, 0);
DECLARE_DEV_RESET(i2c1, 0, 0, 0);
DECLARE_DEV(i2c1, ASPEED_DEV_I2C1, I2C1_BASE, &i2c1_priv);

aspeed_i2c_priv_t i2c2_priv = {.parent = &i2c_global, .bus_clk = 400000, .irq = I2c2_IRQn, .buff_addr = I2C2_BUFF_BASE};
...
aspeed_i2c_priv_t i2c6_priv = {.parent = &i2c_global, .bus_clk = 400000, .irq = I2c6_IRQn, .buff_addr = I2C6_BUFF_BASE};
...
ADC_DEVICE_DECLARE(0, 2500, 0, 1);
ADC_DEVICE_DECLARE(1, 2500, 0, 1);
