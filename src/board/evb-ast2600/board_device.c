...
aspeed_mac_priv_t mac0_priv = { .cfg_rgmii.reg_set = SCU_BASE + 0x500, .cfg_rgmii.reg_clr = SCU_BASE + 0x504, .cfg_rgmii.bits = BIT(6) };
aspeed_mac_priv_t mac1_priv = { .cfg_rgmii.reg_set = SCU_BASE + 0x500, .cfg_rgmii.reg_clr = SCU_BASE + 0x504, .cfg_rgmii.bits = BIT(7) };
aspeed_mac_priv_t mac2_priv = { .cfg_rgmii.reg_set = SCU_BASE + 0x510, .cfg_rgmii.reg_clr = SCU_BASE + 0x514, .cfg_rgmii.bits = BIT(0) };
aspeed_mac_priv_t mac3_priv = { .cfg_rgmii.reg_set = SCU_BASE + 0x510, .cfg_rgmii.reg_clr = SCU_BASE + 0x514, .cfg_rgmii.bits = BIT(1) };

DECLARE_DEV_CLK(mac0, SCU_BASE + 0x84, SCU_BASE + 0x80, BIT(20));
DECLARE_DEV_RESET(mac0, SCU_BASE + 0x40, SCU_BASE + 0x44, BIT(11));
DECLARE_DEV(mac0, ASPEED_DEV_MAC0, MAC0_BASE, &mac0_priv);

DECLARE_DEV_CLK(mac1, SCU_BASE + 0x84, SCU_BASE + 0x80, BIT(21));
DECLARE_DEV_RESET(mac1, SCU_BASE + 0x40, SCU_BASE + 0x44, BIT(12));
DECLARE_DEV(mac1, ASPEED_DEV_MAC1, MAC1_BASE, &mac1_priv);

DECLARE_DEV_CLK(mac2, SCU_BASE + 0x94, SCU_BASE + 0x90, BIT(20));
DECLARE_DEV_RESET(mac2, SCU_BASE + 0x50, SCU_BASE + 0x54, BIT(20));
DECLARE_DEV(mac2, ASPEED_DEV_MAC2, MAC2_BASE, &mac2_priv);

DECLARE_DEV_CLK(mac3, SCU_BASE + 0x94, SCU_BASE + 0x90, BIT(21));
DECLARE_DEV_RESET(mac3, SCU_BASE + 0x50, SCU_BASE + 0x54, BIT(21));
DECLARE_DEV(mac3, ASPEED_DEV_MAC3, MAC3_BASE, &mac3_priv);
