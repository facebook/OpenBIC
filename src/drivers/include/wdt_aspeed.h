...
#define WDT_RESET_MASK_1_REG 0x1C
#define WDT_RESET_MASK_2_REG 0x20


static inline void wdt_init()
{
	writel(CONFIG_WDT_TIMEOUT_MS * 1000, WDT0_BASE + WDT_COUNTER_RELOAD_REG);
	writel(CONFIG_WDT_RESET_MASK_1, WDT0_BASE + WDT_RESET_MASK_1_REG);
	writel(CONFIG_WDT_RESET_MASK_2, WDT0_BASE + WDT_RESET_MASK_2_REG);
}
