...
uint8_t nct363_read(sensor_cfg *cfg, int *reading)
{
	...
	case NCT7363_FAN_SPEED_OFFSET:
		uint8_t fan_count_high_byte_offset = nct7363_REG_FAN_COUNT_VALUE_HIGH_BYTE_BASE_OFFSET + port_offset*2;
		uint8_t fan_count_low_byte_offset = nct7363_REG_FAN_COUNT_VALUE_LOW_BYTE_BASE_OFFSET + port_offset*2;
		msg.rx_len = 1 ;
		msg.tx_len = 1;
...
uint8_t nct363_init(sensor_cfg *cfg)
{
	...
	/* init_pin_config */
	uint8_t gpio_00_to_03_pin_configuration_reg_msg = cfg->init_args.init_pin_config.GPIO_00_to_03_Pin_Function_Configuration;
	uint8_t gpio_04_to_07_pin_configuration_reg_msg = cfg->init_args.init_pin_config.GPIO_04_to_07_Pin_Function_Configuration;
	uint8_t gpio_10_to_13_pin_configuration_reg_msg = cfg->init_args.init_pin_config.GPIO_10_to_13_Pin_Function_Configuration;
	uint8_t gpio_14_to_17_pin_configuration_reg_msg = cfg->init_args.init_pin_config.GPIO_14_to_17_Pin_Function_Configuration;
	/* init_16_pin_config */
	uint8_t nct7363_reg_pwm_ctrl_output_0_to_7_msg = cfg->init_args.init_pin_config.PWM_0_to_7_Enable;
	uint8_t nct7363_reg_pwml_ctr_outpu_8_to_15_msg = cfg->init_args.init_pin_config.PWM_8_to_15_Enable;
	...
	uint8_t gpio0x_input_output_configuration_msg = cfg->init_args.init_pin_config.GPIO0x_Input_Output_Configuration;
	uint8_t gpio1x_input_output_configuration_msg = cfg->init_args.init_pin_config.GPIO1x_Input_Output_Configuration;
