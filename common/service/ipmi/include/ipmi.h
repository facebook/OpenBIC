...
enum {
	...
	CMD_OEM_1S_ERASE_BIOS_FLASH = 0xB4,
	CMD_OEM_1S_GET_BIOS_ERASE_PROGRESS = 0xB5,

	CMD_OEM_1S_GET_80PORT_RECORD = 0x49,
	CMD_OEM_1S_SET_POSTCODE_FILTER = 0xB6,
	CMD_OEM_1S_GET_POSTCODE_FILTER = 0xB7,
	CMD_OEM_1S_GET_FILTERED_AMD_POST_CODE = 0xB8,
};
