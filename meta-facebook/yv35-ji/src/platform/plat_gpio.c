...
GPIO_CFG plat_gpio_cfg[] = {
	...
	{ CHIP_GPIO, 13, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_HIGH, OPEN_DRAIN, GPIO_INT_EDGE_FALLING, ISR_RTC_CLR },
	...
	/** Group L: 88-95 **/
	{ CHIP_GPIO, 88, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_HIGH, PUSH_PULL, GPIO_INT_DISABLE, NULL },
	...
	{ CHIP_GPIO, 91, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_EDGE_BOTH, ISR_RETIMER_FAULT },
	{ CHIP_GPIO, 92, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
