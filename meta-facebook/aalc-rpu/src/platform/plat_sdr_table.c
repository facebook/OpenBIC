...
SDR_Full_sensor plat_sdr_table[] = {
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_HSC_TEMP_C, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_HSC_P48V_VIN_VOLT_V, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_HSC_P48V_IOUT_CURR_A, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_HSC_P48V_PIN_PWR_W, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_FAN_TACH_RPM, // sensor number
	...
	{
		// SENSOR_NUM_FB_15_HEX_INLET_TEMP_C
		0x00,
		0x00, // record ID
		IPMI_SDR_VER_15, // SDR ver
		IPMI_SDR_FULL_SENSOR, // record type
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_HEX_INLET_TEMP_C, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_FB_15_HUM_PCT_RH, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_V_5_AUX, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_V_1_2_AUX, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_V_5_USB, // sensor number
	...
	},
	{
		...
		0x00, // OEM
		IPMI_SDR_STRING_TYPE_ASCII_8, // ID len, should be same as "size of struct"
		"SB_TTV_COOLANT_LEAKAGE_1_VOLT_V",
	},
	{
		...
		0x00, // OEM
		IPMI_SDR_STRING_TYPE_ASCII_8, // ID len, should be same as "size of struct"
		"SB_TTV_COOLANT_LEAKAGE_2_VOLT_V",
	},
	{
		...
		0x00, // OEM
		IPMI_SDR_STRING_TYPE_ASCII_8, // ID len, should be same as "size of struct"
		"SB_TTV_COOLANT_LEAKAGE_3_VOLT_V",
	},
	{
