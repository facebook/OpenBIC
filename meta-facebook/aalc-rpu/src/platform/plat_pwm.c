...
struct nct_dev_info {
	...
	uint8_t pwm_port; /* pwm pin index of nct */
		    ...
		    { PWM_DEVICE_E_FB_FAN_15, SENSOR_NUM_FB_15_FAN_TACH_RPM, NCT7363_17_PORT },
...
uint8_t set_pwm_grup(uint8_t grup, uint8_t duty)
{
	...
	case PWM_GRUP_E_HEX_FAN:
		if (!ctl_pwm_dev(PWM_DEVICE_E_FB_FAN_1, PWM_DEVICE_E_FB_FAN_15, duty))
			ret = 0;
		break;
