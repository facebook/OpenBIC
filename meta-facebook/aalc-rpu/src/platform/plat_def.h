...
#define ENABLE_NCT7363
#define ENABLE_ADS112C
#define ENABLE_HDC1080
#define ENABLE_INA238
#define ENABLE_NCT214
#define ENABLE_AST_TACH
#define ENABLE_XDP710
#define ENABLE_BMR4922302_803
#define ENABLE_TMP421
