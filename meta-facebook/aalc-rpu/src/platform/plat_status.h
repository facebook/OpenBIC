...
enum AALC_STICKY_STATUS_E {
	...
	STICKY_PUMP_1_SPEED_ABNORMAL, //0x1991 bit0
	STICKY_PUMP_1_SPEED_NOT_ACCESS, //0x1991 bit1
	STICKY_PUMP_2_SPEED_ABNORMAL, //0x1992 bit0
	STICKY_PUMP_2_SPEED_NOT_ACCESS, //0x1992 bit1
	STICKY_PUMP_3_SPEED_ABNORMAL, //0x1993 bit0
	STICKY_PUMP_3_SPEED_NOT_ACCESS, //0x1993 bit1
	STICKY_HEX_BLADDER_ABNORMAL, //0x1994 bit0
	STICKY_RPU_RESERVOIR_ABNORMAL, //0x1994 bit1
	STICKY_RPU_COOLANT_FLOW_BLOCKED, //0x1994 bit2
	STICKY_RPU_OUTLET_PRESSURE_HIGH, //0x1994 bit3
	STICKY_PUMP_1_SPEED_UCR, //0x1994 bit4
	STICKY_PUMP_2_SPEED_UCR, //0x1994 bit5
	STICKY_PUMP_3_SPEED_UCR, //0x1994 bit6
	STICKY_STATUS_MAX,
};
