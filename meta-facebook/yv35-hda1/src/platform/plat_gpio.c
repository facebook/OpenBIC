...
GPIO_CFG plat_gpio_cfg[] = {
	...
	{ CHIP_GPIO, 2, ENABLE, DISABLE, GPIO_INPUT, GPIO_HIGH, OPEN_DRAIN, GPIO_INT_EDGE_RISING, ISR_CPU_FAULT_ALERT },
	...
	/** Group O: 112-119 **/
	{ CHIP_GPIO, 112, ENABLE, DISABLE, GPIO_OUTPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_DISABLE, NULL },
