...
#define name_gpioA                                                                                 \
	gpio_name_to_num(SMB_TEMP_ALERT_BIC_N) gpio_name_to_num(SMB_BIC_HOTSWAP_ALERT_N_R)         \
...
#define name_gpioB                                                                                 \
	gpio_name_to_num(FM_RESBTN_SLOT1_BIC_N) gpio_name_to_num(FM_RESBTN_SLOT3_BIC_N)            \
		gpio_name_to_num(FM_BIC_SLOT1_ISOLATED_EN_R) gpio_name_to_num(                     \
			FM_BIC_SLOT3_ISOLATED_EN_R) gpio_name_to_num(FAST_PROCHOT_BIC_N_R)         \
...
#define name_gpioC                                                                                 \
	gpio_name_to_num(DUAL_FAN0_DETECT_BIC_N_R) gpio_name_to_num(DUAL_FAN1_DETECT_BIC_N_R)      \
		gpio_name_to_num(FAN0_BIC_CPLD_EN_R) gpio_name_to_num(FAN1_BIC_CPLD_EN_R)          \
			gpio_name_to_num(FAN2_BIC_CPLD_EN_R) gpio_name_to_num(FAN3_BIC_CPLD_EN_R)  \
				gpio_name_to_num(BB_BUTTON_BMC_BIC_N_R)                            \
					gpio_name_to_num(USB_CPLD_BIC_EN_R)
#define name_gpioD                                                                                 \
	gpio_name_to_num(P5V_USB_PG_BIC) gpio_name_to_num(OCP_DEBUG_BIC_PRSNT_N_R)                 \
		gpio_name_to_num(FM_HSC_BIC_FAULT_N_R) gpio_name_to_num(BIC_READY_R)               \
			gpio_name_to_num(BOARD_ID0) gpio_name_to_num(BOARD_ID1)                    \
				gpio_name_to_num(BOARD_ID2) gpio_name_to_num(BOARD_ID3)
#define name_gpioE                                                                                 \
	gpio_name_to_num(SLOT1_ID1_DETECT_BIC_N) gpio_name_to_num(SLOT1_ID0_DETECT_BIC_N)          \
		gpio_name_to_num(SLOT2_ID1_DETECT_BIC_N) gpio_name_to_num(SLOT2_ID0_DETECT_BIC_N)  \
...
#define name_gpioF                                                                                 \
	gpio_name_to_num(Reserve_GPIOF0) gpio_name_to_num(Reserve_GPIOF1)                          \
		gpio_name_to_num(Reserve_GPIOF2) gpio_name_to_num(Reserve_GPIOF3)                  \
			gpio_name_to_num(Reserve_GPIOF4) gpio_name_to_num(Reserve_GPIOF5)          \
				gpio_name_to_num(Reserve_GPIOF6) gpio_name_to_num(Reserve_GPIOF7)
#define name_gpioG                                                                                 \
	gpio_name_to_num(Reserve_GPIOG0) gpio_name_to_num(Reserve_GPIOG1)                          \
		gpio_name_to_num(Reserve_GPIOG2) gpio_name_to_num(Reserve_GPIOG3)                  \
			gpio_name_to_num(Reserve_GPIOG4) gpio_name_to_num(Reserve_GPIOG5)          \
				gpio_name_to_num(Reserve_GPIOG6) gpio_name_to_num(Reserve_GPIOG7)
#define name_gpioH                                                                                 \
	gpio_name_to_num(Reserve_GPIOH0) gpio_name_to_num(Reserve_GPIOH1)                          \
...
#define name_gpioL                                                                                 \
	gpio_name_to_num(Reserve_GPIOL0) gpio_name_to_num(TP_SLOT1_BIC_RSVD2)                      \
		gpio_name_to_num(TP_SLOT1_BIC_RSVD3) gpio_name_to_num(TP_SLOT1_BIC_RSVD4)          \
			gpio_name_to_num(TP_SLOT1_BIC_RSVD5) gpio_name_to_num(TP_SLOT1_BIC_RSVD6)  \
				gpio_name_to_num(TP_SLOT1_BIC_RSVD7)                               \
					gpio_name_to_num(TP_SLOT1_BIC_RSVD0)
#define name_gpioM                                                                                 \
	gpio_name_to_num(BIC_STRAP_TXD6) gpio_name_to_num(TP_SLOT3_BIC_RSVD2)                      \
		gpio_name_to_num(BIC_STRAP_TXD7) gpio_name_to_num(TP_SLOT3_BIC_RSVD4)              \
			gpio_name_to_num(USB_SW_EN_BIC_N_R) gpio_name_to_num(USB_SW_BIC_CB_R)      \
				gpio_name_to_num(Reserve_GPIOM6) gpio_name_to_num(Reserve_GPIOM7)
#define name_gpioN                                                                                 \
	gpio_name_to_num(BIC_SGPMCK) gpio_name_to_num(Reserve_GPION1) gpio_name_to_num(BIC_SGPMO)  \
		gpio_name_to_num(Reserve_GPION3) gpio_name_to_num(Reserve_GPION4)                  \
			gpio_name_to_num(Reserve_GPION5) gpio_name_to_num(Reserve_GPION6)          \
...
#define name_gpioQ                                                                                 \
	gpio_name_to_num(Reserve_GPIOQ0) gpio_name_to_num(Reserve_GPIOQ1)                          \
		gpio_name_to_num(Reserve_GPIOQ3) gpio_name_to_num(Reserve_GPIOQ4)                  \
			gpio_name_to_num(Reserve_GPIOQ5) gpio_name_to_num(Reserve_GPIOQ6)          \
