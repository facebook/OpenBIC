...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_VOL_P3V3_STBY, sensor_dev_ast_adc, ADC_PORT2, NONE, NONE, stby_access, 487,
	  200, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL,
	  NULL, &adc_asd_init_args[0] },
	...
	{ SENSOR_NUM_VOL_P1V2_BIC_STBY, sensor_dev_ast_adc, ADC_PORT5, NONE, NONE, stby_access, 1,
	  1, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	...
	{ SENSOR_NUM_CUR_P12V_FAN, sensor_dev_ast_adc, ADC_PORT6, NONE, NONE, stby_access, 10000,
	  1463, SAMPLE_COUNT_FAN_IOUT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL,
	  NULL, &adc_asd_init_args[0] },

	// medusa board
	{ SENSOR_NUM_VOL_MEDUSA_12V_IN, sensor_dev_ltc4282, I2C_BUS2, MEDUSA_ADDR,
	  MEDUSA_VOL_OUT_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0,
	  SENSOR_INIT_STATUS, pre_ltc4282_read, &ltc4282_pre_read_args[0], NULL, NULL,
	  &ltc4282_init_args[0] },
	{ SENSOR_NUM_VOL_MEDUSA_12V_OUT, sensor_dev_ltc4282, I2C_BUS2, MEDUSA_ADDR,
	  MEDUSA_VOL_IN_OFFSET, stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0,
	  SENSOR_INIT_STATUS, pre_ltc4282_read, &ltc4282_pre_read_args[1], NULL, NULL,
	  &ltc4282_init_args[0] },
	{ SENSOR_NUM_CUR_MEDUSA_IOUT, sensor_dev_ltc4282, I2C_BUS2, MEDUSA_ADDR, MEDUSA_CUR_OFFSET,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL,
	  NULL, NULL, NULL, &ltc4282_init_args[0] },
