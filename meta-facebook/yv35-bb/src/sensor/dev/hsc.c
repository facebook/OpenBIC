...
bool hsc_init()
{
	...
	msg.target_addr = sensor_config[sensor_config_index_map[SENSOR_NUM_TEMP_HSC]].target_addr;
	msg.tx_len = 3;
	msg.data[0] = 0xD4;
	msg.data[1] = 0x1C;
	msg.data[2] = 0x3F;
	...
	if (!i2c_master_write(&msg, retry)) {
		...
		msg.bus = sensor_config[sensor_config_index_map[SENSOR_NUM_TEMP_HSC]].port;
		msg.target_addr =
			sensor_config[sensor_config_index_map[SENSOR_NUM_TEMP_HSC]].target_addr;
		msg.tx_len = 1;
		msg.data[0] = 0xD4;
		msg.rx_len = 2;
