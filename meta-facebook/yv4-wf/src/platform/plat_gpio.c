...
GPIO_CFG plat_gpio_cfg[] = {
	...
	{ CHIP_GPIO, 7, ENABLE, ENABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_EDGE_BOTH, ISR_MB_DC_STAGUS_CHAGNE },
	...
	{ CHIP_GPIO, 43, ENABLE, ENABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_EDGE_BOTH, ISR_P3V3_E1S_PWR_CHANGE },
	...
	{ CHIP_GPIO, 51, ENABLE, ENABLE, GPIO_INPUT, GPIO_LOW, PUSH_PULL, GPIO_INT_EDGE_BOTH, ISR_P12V_E1S_PWR_CHANGE },
