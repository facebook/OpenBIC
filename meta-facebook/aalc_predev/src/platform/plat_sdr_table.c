...
SDR_Full_sensor plat_sdr_table[] = {
	...
	{}, //SENSOR_NUM_V_1_2_AUX
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_SB_LEAKAGE_1, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_SB_LEAKAGE_2, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_SB_LEAKAGE_3, // sensor number
