...
modbus_command_mapping modbus_command_table[] = {
	...
	// FRU(EVT3 is supported)
	{ MODBUS_RPU_FBPN_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 8 },
	{ MODBUS_RPU_MFR_MODEL_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 8 },
	{ MODBUS_RPU_MFR_DATE_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_RPU_MFR_SERIAL_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 8 },
	{ MODBUS_RPU_WORKORDER_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_RPU_HW_REVISION_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_RPU_PLC_FW_REVISION_ADDR, NULL, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_TOTAL_UP_TIME_ADDR, NULL, modbus_to_do, 0, 0, 0, 2 },
	{ MODBUS_TIME_SINCE_LAST_ON_ADDR, NULL, modbus_to_do, 0, 0, 0, 2 },
	{ MODBUS_RPU_HMI_FW_REVISION_ADDR, NULL, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_RPU_HEX_FW_REVISION_ADDR, NULL, modbus_to_do, 0, 0, 0, 2 },
	{ MODBUS_RPU_NOAHS_ARK_CONFIGURATION_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_RPU_RESERVIOR_AND_PUMPING_UNIT_FBPN_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_HEAT_EXCHANGER_CONTROL_BOX_FBPN_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_HEAT_EXCHANGER_FANS_FBPN_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	{ MODBUS_HEAT_EXCHANGER_FAN_CONTROL_BOX_FBPN_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 4 },
	// Error Log
	{ MODBUS_ERROR_LOG_COUNT_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_INDEX_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_ERROR_CODE_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_SYSTEM_UPTIME_ADDR, NULL, modbus_to_do, 0, 0, 0, 2 },
	{ MODBUS_EVENT_1_PUMP_DUTY_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_HEX_FAN_DUTY_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_OUTELET_TEMPERATURE_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_OUTLET_PRESSURE_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_FLOW_RATE_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_EVENT_1_VOLTAGE_ADDR, NULL, modbus_to_do, 0, 0, 0, 1 },
	...
	// FW Upgrade Registers(EVT2 is supported)
	{ MODBUS_SET_RPU_STOP_OR_RUN_ADDR, modbus_to_do, modbus_to_do, 0, 0, 0, 1 },
	{ MODBUS_ENABLE_OR_DISABLE_FIRMWARE_UPDATE_ADDR, modbus_to_do, NULL, 0, 0, 0, 1 },
	{ MODBUS_SYNTAX_CHECK_ADDR, modbus_to_do, NULL, 0, 0, 0, 1 },
	// FRU write read
