...
#define SENSOR_NUM_BPB_CDU_COOLANT_LEAKAGE_V 0xA2
#define SENSOR_NUM_BPB_RACK_COOLANT_LEAKAGE_V 0xA3
#define SENSOR_NUM_SB_LEAKAGE_1_V 0xA4
#define SENSOR_NUM_SB_LEAKAGE_2_V 0xA5
#define SENSOR_NUM_SB_LEAKAGE_3_V 0xA6
