...
const mps_vr_test_mode_setting_t vr_mps_test_mode_table[] = {
	...
	*/
	...
	{ VR_RAIL_E_ASIC_P0V85_MEDHA1_VDD, 1424, NO_USE, 500, 595, 930, NO_USE, NO_USE, NO_ACTION,
	  940, NO_USE, 930 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, 17, 0, NO_USE, 630, 1120, NO_USE, NO_USE, NO_ACTION, 1170,
	NO_USE, 1120, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, 11, 0, NO_USE, 525, 975, NO_USE, NO_USE, NO_ACTION, 1175,
	NO_USE, 975, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_M_VDD, 120, 0, NO_USE, 525, 975, NO_USE, NO_USE, NO_ACTION, 1175,
	NO_USE, 975, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM1357, 138, 0, NO_USE, 525, 930, NO_USE, NO_USE, NO_ACTION, 980,
	NO_USE, 930, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, 159, 0, NO_USE, 525, 930, NO_USE, NO_USE, NO_ACTION, 980,
	NO_USE, 930, NO_USE },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 53, 0, NO_USE, 280, 520, NO_USE, NO_USE, NO_ACTION, 820,
	NO_USE, 520, NO_USE },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM1357, 318, 0, NO_USE, 770, 1310, NO_USE, NO_USE, NO_ACTION, 1360,
	NO_USE, 1310, NO_USE },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, 14, 0, NO_USE, 1260, 1970, NO_USE, NO_USE, NO_ACTION, 2020,
	NO_USE, 1970, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, 67, 0, NO_USE, 525, 975, NO_USE, NO_USE, NO_ACTION, 1175,
	NO_USE, 975, NO_USE },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, 50, 0, NO_USE, 560, 1040, NO_USE, NO_USE, NO_ACTION, 1140,
	NO_USE, 1040, NO_USE },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, 10, 0, NO_USE, 840, 1310, NO_USE, NO_USE, NO_ACTION, 1360,
	NO_USE, 1310, NO_USE },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 100, 0, NO_USE, 595, 1053, NO_USE, NO_USE, NO_ACTION, 1053,
	NO_USE, 1053, NO_USE },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM0246, 318, 0, NO_USE, 770, 1310, NO_USE, NO_USE, NO_ACTION, 1360,
	NO_USE, 1310, NO_USE },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, 14, 0, NO_USE, 1260, 1970, NO_USE, NO_USE, NO_ACTION, 2020,
	NO_USE, 1970, NO_USE },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 53, 0, NO_USE, 280, 520, NO_USE, NO_USE, NO_ACTION, 820,
	NO_USE, 520, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 138, 0, NO_USE, 525, 930, NO_USE, NO_USE, NO_ACTION, 980,
	NO_USE, 930, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 159, 0, NO_USE, 525, 930, NO_USE, NO_USE, NO_ACTION, 980,
	NO_USE, 930, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 66, 0, NO_USE, 525, 975, NO_USE, NO_USE, NO_ACTION, 1175,
	NO_USE, 975, NO_USE },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, 17, 0, NO_USE, 630, 1120, NO_USE, NO_USE, NO_ACTION, 1170,
	NO_USE, 1120, NO_USE },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, 11, 0, NO_USE, 525, 975, NO_USE, NO_USE, NO_ACTION, 1175,
	NO_USE, 975, NO_USE },
};
const mps_vr_test_mode_setting_t vr_mps_normal_mode_table[] = {
	...
	*/
	...
	{ VR_RAIL_E_ASIC_P0V85_MEDHA1_VDD, 1424, NO_USE, 200, 782, 918, NO_USE, NO_USE, 980, 940,
	  850, 918, 680 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_E_TRVDD, 16, 1, NO_USE, 846, 955, NO_USE, NO_USE, 1010, 1055,
	900, 955, 700 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_TRVDD, 10, 1, NO_USE, 705, 795, NO_USE, NO_USE, 865, 945,
	750, 795, 580 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_M_VDD, 58, 1, NO_USE, 690, 850, NO_USE, NO_USE, 885, 950,
	750, 850, 575 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM1357, 114, 1, NO_USE, 705, 795, NO_USE, NO_USE, 880, 895,
	750, 795, 595 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_E_VDD, 150, 1, NO_USE, 690, 810, NO_USE, NO_USE, 880, 910,
	750, 810, 595 },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM1357, 36, 1, NO_USE, 380, 440, NO_USE, NO_USE, 605, 790,
	400, 440, 330 },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM1357, 270, 1, NO_USE, 1067, 1175, NO_USE, NO_USE, 1225, 1275,
	1100, 1175, 915 },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM1357, 14, 1, NO_USE, 1746, 1950, NO_USE, NO_USE, 1960, 2000,
	1800, 1950, 1420 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_N_VDD, 57, 1, NO_USE, 690, 850, NO_USE, NO_USE, 880, 950,
	750, 850, 595 },
	{ VR_RAIL_E_ASIC_P0V8_HAMSA_AVDD_PCIE, 40, 1, NO_USE, 752, 850, NO_USE, NO_USE, 920, 950,
	800, 850, 635 },
	{ VR_RAIL_E_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE, 9, 1, NO_USE, 1128, 1270, NO_USE, NO_USE, 1310, 1320,
	1200, 1270, 1000 },
	{ VR_RAIL_E_ASIC_P0V85_HAMSA_VDD, 76, 1, NO_USE, 782, 920, NO_USE, NO_USE, 945, 970,
	850, 920, 675 },
	{ VR_RAIL_E_ASIC_P1V1_VDDQC_HBM0246, 270, 1, NO_USE, 1067, 1175, NO_USE, NO_USE, 1225, 1275,
	1100, 1175, 915 },
	{ VR_RAIL_E_ASIC_P1V8_VPP_HBM0246, 14, 1, NO_USE, 1746, 1950, NO_USE, NO_USE, 1960, 2000,
	1800, 1950, 1420 },
	{ VR_RAIL_E_ASIC_P0V4_VDDQL_HBM0246, 36, 1, NO_USE, 380, 440, NO_USE, NO_USE, 605, 790,
	400, 440, 330 },
	{ VR_RAIL_E_ASIC_P0V75_VDDPHY_HBM0246, 114, 1, NO_USE, 705, 795, NO_USE, NO_USE, 880, 895,
	750, 795, 595 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_VDD, 150, 1, NO_USE, 690, 810, NO_USE, NO_USE, 875, 910,
	750, 810, 590 },
	{ VR_RAIL_E_ASIC_P0V75_MAX_S_VDD, 48, 1, NO_USE, 690, 850, NO_USE, NO_USE, 860, 950,
	750, 850, 550 },
	{ VR_RAIL_E_ASIC_P0V9_OWL_W_TRVDD, 16, 1, NO_USE, 846, 955, NO_USE, NO_USE, 970, 1055,
	900, 955, 700 },
	{ VR_RAIL_E_ASIC_P0V75_OWL_W_TRVDD, 10, 1, NO_USE, 705, 795, NO_USE, NO_USE, 865, 945,
	750, 795, 580 },
};
//clang-format on
