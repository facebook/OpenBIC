...
const vr_fault_info vr_fault_table[] = {
    ...
    // VR Power Fault 1
    { IRIS_OWL_E_TRVDD0P9, VR_POWER_FAULT_1_REG, BIT(7), true, SENSOR_NUM_ASIC_P0V9_OWL_E_TRVDD_VOLT_V },
    { IRIS_OWL_W_TRVDD0P9, VR_POWER_FAULT_1_REG, BIT(6), true, SENSOR_NUM_ASIC_P0V9_OWL_W_TRVDD_VOLT_V },
    { IRIS_OWL_E_TRVDD0P75, VR_POWER_FAULT_1_REG, BIT(5), true, SENSOR_NUM_ASIC_P0V75_OWL_E_TRVDD_VOLT_V },
	{ IRIS_OWL_W_TRVDD0P75, VR_POWER_FAULT_1_REG, BIT(4), true, SENSOR_NUM_ASIC_P0V75_OWL_W_TRVDD_VOLT_V },
    { IRIS_HAMSA_AVDD_PCIE, VR_POWER_FAULT_1_REG, BIT(3), true, SENSOR_NUM_ASIC_P0V8_HAMSA_AVDD_PCIE_VOLT_V },
    { IRIS_HAMSA_VDDHRXTX_PCIE, VR_POWER_FAULT_1_REG, BIT(2), true, SENSOR_NUM_ASIC_P1V2_HAMSA_VDDHRXTX_PCIE_VOLT_V },
    // VR Power Fault 2
    { IRIS_MEDHA1_VDD, VR_POWER_FAULT_2_REG, BIT(7), true, SENSOR_NUM_ASIC_P0V85_MEDHA1_VDD_VOLT_V },
    { IRIS_MEDHA0_VDD, VR_POWER_FAULT_2_REG, BIT(6), true, SENSOR_NUM_ASIC_P0V85_MEDHA0_VDD_VOLT_V },
    { IRIS_OWL_E_VDD, VR_POWER_FAULT_2_REG, BIT(5), true, SENSOR_NUM_ASIC_P0V75_OWL_E_VDD_VOLT_V },
    { IRIS_OWL_W_VDD, VR_POWER_FAULT_2_REG, BIT(4), true, SENSOR_NUM_ASIC_P0V75_OWL_W_VDD_VOLT_V },
    { IRIS_HAMSA_VDD, VR_POWER_FAULT_2_REG, BIT(3), true, SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_VOLT_V },
    { IRIS_MAX_S_VDD, VR_POWER_FAULT_2_REG, BIT(2), true, SENSOR_NUM_ASIC_P0V75_MAX_S_VDD_VOLT_V },
    { IRIS_MAX_M_VDD, VR_POWER_FAULT_2_REG, BIT(1), true, SENSOR_NUM_ASIC_P0V75_MAX_M_VDD_VOLT_V },
    { IRIS_MAX_N_VDD, VR_POWER_FAULT_2_REG, BIT(0), true, SENSOR_NUM_ASIC_P0V75_MAX_N_VDD_VOLT_V },
    // VR Power Fault 3
    { IRIS_VDDQL_HBM0_HBM2_HBM4_HBM6, VR_POWER_FAULT_3_REG, BIT(7), true, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM0246_VOLT_V },
    { IRIS_VDDQC_HBM0_HBM2_HBM4_HBM6, VR_POWER_FAULT_3_REG, BIT(6), true, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM0246_VOLT_V },
    { IRIS_VPP_HBM0_HBM2_HBM4_HBM6, VR_POWER_FAULT_3_REG, BIT(5), true, SENSOR_NUM_ASIC_P1V8_VPP_HBM0246_VOLT_V },
    { IRIS_VDDPHY_HBM0_HBM2_HBM4_HBM6, VR_POWER_FAULT_3_REG, BIT(4), true, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM0246_VOLT_V },
    { IRIS_VDDQL_HBM1_HBM3_HBM5_HBM7, VR_POWER_FAULT_3_REG, BIT(3), true, SENSOR_NUM_ASIC_P0V4_VDDQL_HBM1357_VOLT_V },
    { IRIS_VDDQC_HBM1_HBM3_HBM5_HBM7, VR_POWER_FAULT_3_REG, BIT(2), true, SENSOR_NUM_ASIC_P1V1_VDDQC_HBM1357_VOLT_V },
    { IRIS_VPP_HBM1_HBM3_HBM5_HBM7, VR_POWER_FAULT_3_REG, BIT(1), true, SENSOR_NUM_ASIC_P1V8_VPP_HBM1357_VOLT_V },
    { IRIS_VDDPHY_HBM1_HBM3_HBM5_HBM7, VR_POWER_FAULT_3_REG, BIT(0), true, SENSOR_NUM_ASIC_P0V75_VDDPHY_HBM1357_VOLT_V },
    // VR Power Fault 4
...
void process_mtia_vr_power_fault_sel(rainbow_cpld_info *cpld_info, uint8_t *current_cpld_value)
{
