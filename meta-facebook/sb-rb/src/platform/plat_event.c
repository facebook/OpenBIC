...
const vr_fault_info vr_fault_table[] = {
	...
	{ IRIS_MEDHA0_VDD, VR_POWER_FAULT_2_REG, BIT(6), true,
	  SENSOR_NUM_ASIC_P0V85_MEDHA0_VDD_VOLT_V },
	{ IRIS_OWL_E_VDD, VR_POWER_FAULT_2_REG, BIT(5), true,
	  SENSOR_NUM_ASIC_P0V75_OWL_E_VDD_VOLT_V },
	{ IRIS_OWL_W_VDD, VR_POWER_FAULT_2_REG, BIT(4), true,
	  SENSOR_NUM_ASIC_P0V75_OWL_W_VDD_VOLT_V },
	{ IRIS_HAMSA_VDD, VR_POWER_FAULT_2_REG, BIT(3), true,
	  SENSOR_NUM_ASIC_P0V85_HAMSA_VDD_VOLT_V },
	{ IRIS_MAX_S_VDD, VR_POWER_FAULT_2_REG, BIT(2), true,
	  SENSOR_NUM_ASIC_P0V75_MAX_S_VDD_VOLT_V },
	{ IRIS_MAX_M_VDD, VR_POWER_FAULT_2_REG, BIT(1), true,
	  SENSOR_NUM_ASIC_P0V75_MAX_M_VDD_VOLT_V },
	{ IRIS_MAX_N_VDD, VR_POWER_FAULT_2_REG, BIT(0), true,
