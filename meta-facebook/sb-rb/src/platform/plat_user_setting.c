...
temp_mapping_sensor temp_index_table[] = {
	...
	{ TEMP_INDEX_ASIC_MEDHA0_SENSOR0, SENSOR_NUM_ASIC_MEDHA0_SENSOR0_TEMP_C, "SB_RB_ASIC_MEDHA0_SENSOR0_TEMP" },
	{ TEMP_INDEX_ASIC_MEDHA0_SENSOR1, SENSOR_NUM_ASIC_MEDHA0_SENSOR1_TEMP_C, "SB_RB_ASIC_MEDHA0_SENSOR1_TEMP" },
	...
	{ TEMP_INDEX_ASIC_MEDHA1_SENSOR0, SENSOR_NUM_ASIC_MEDHA1_SENSOR0_TEMP_C, "SB_RB_ASIC_MEDHA1_SENSOR0_TEMP" },
	{ TEMP_INDEX_ASIC_MEDHA1_SENSOR1, SENSOR_NUM_ASIC_MEDHA1_SENSOR1_TEMP_C, "SB_RB_ASIC_MEDHA1_SENSOR1_TEMP" },
	{ TEMP_INDEX_ASIC_HAMSA_CRM, SENSOR_NUM_ASIC_HAMSA_CRM_TEMP_C, "SB_RB_ASIC_HAMSA_CRM_TEMP" },
...
temp_threshold_mapping_sensor temp_index_threshold_type_table[] = {
	{ TOP_INLET_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_TOP_INLET_TEMP_C, "SB_RB_TOP_INLET_TEMP_LOW_LIM" },
	{ TOP_INLET_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_TOP_INLET_TEMP_C, "SB_RB_TOP_INLET_TEMP_HIGH_LIM" },
	{ BOT_INLET_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_BOT_INLET_TEMP_C, "SB_RB_BOT_INLET_TEMP_LOW_LIM" },
	{ BOT_INLET_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_BOT_INLET_TEMP_C, "SB_RB_BOT_INLET_TEMP_HIGH_LIM" },
	{ BOT_OUTLET_LOW_LIMIT, LOCAL_LOW_LIMIT, SENSOR_NUM_BOT_OUTLET_TEMP_C, "SB_RB_BOT_OUTLET_TEMP_LOW_LIM" },
	{ BOT_OUTLET_HIGH_LIMIT, LOCAL_HIGH_LIMIT, SENSOR_NUM_BOT_OUTLET_TEMP_C, "SB_RB_BOT_OUTLET_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA0_SENSOR0_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA0_SENSOR0_TEMP_C, "SB_RB_ASIC_MEDHA0_SENSOR0_TEMP_LOW_LIM" },
	{ ASIC_MEDHA0_SENSOR0_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA0_SENSOR0_TEMP_C, "SB_RB_ASIC_MEDHA0_SENSOR0_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA0_SENSOR1_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA0_SENSOR1_TEMP_C, "SB_RB_ASIC_MEDHA0_SENSOR1_TEMP_LOW_LIM" },
	{ ASIC_MEDHA0_SENSOR1_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA0_SENSOR1_TEMP_C, "SB_RB_ASIC_MEDHA0_SENSOR1_TEMP_HIGH_LIM" },
	{ ASIC_OWL_W_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_W_TEMP_C, "SB_RB_ASIC_OWL_W_TEMP_LOW_LIM" },
	{ ASIC_OWL_W_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_W_TEMP_C, "SB_RB_ASIC_OWL_W_TEMP_HIGH_LIM" },
	{ ASIC_OWL_E_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_OWL_E_TEMP_C, "SB_RB_ASIC_OWL_E_TEMP_LOW_LIM" },
	{ ASIC_OWL_E_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_OWL_E_TEMP_C, "SB_RB_ASIC_OWL_E_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA1_SENSOR0_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA1_SENSOR0_TEMP_C, "SB_RB_ASIC_MEDHA1_SENSOR0_TEMP_LOW_LIM" },
	{ ASIC_MEDHA1_SENSOR0_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA1_SENSOR0_TEMP_C, "SB_RB_ASIC_MEDHA1_SENSOR0_TEMP_HIGH_LIM" },
	{ ASIC_MEDHA1_SENSOR1_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_MEDHA1_SENSOR1_TEMP_C, "SB_RB_ASIC_MEDHA1_SENSOR1_TEMP_LOW_LIM" },
	{ ASIC_MEDHA1_SENSOR1_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_MEDHA1_SENSOR1_TEMP_C, "SB_RB_ASIC_MEDHA1_SENSOR1_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_CRM_LOW_LIMIT, REMOTE_1_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_CRM_TEMP_C, "SB_RB_ASIC_HAMSA_CRM_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_CRM_HIGH_LIMIT, REMOTE_1_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_CRM_TEMP_C, "SB_RB_ASIC_HAMSA_CRM_TEMP_HIGH_LIM" },
	{ ASIC_HAMSA_LS_LOW_LIMIT, REMOTE_2_LOW_LIMIT, SENSOR_NUM_ASIC_HAMSA_LS_TEMP_C, "SB_RB_ASIC_HAMSA_LS_TEMP_LOW_LIM" },
	{ ASIC_HAMSA_LS_HIGH_LIMIT, REMOTE_2_HIGH_LIMIT, SENSOR_NUM_ASIC_HAMSA_LS_TEMP_C, "SB_RB_ASIC_HAMSA_LS_TEMP_HIGH_LIM" },
};
