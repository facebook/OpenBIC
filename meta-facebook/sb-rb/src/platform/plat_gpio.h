...
#define name_gpio2	\
	...
	gpio_name_to_num(MEDHA0_HBM_CATTRIP_MMC_LVC33_R_ALARM)
#define name_gpio3	\
...
#define name_gpio5	\
	gpio_name_to_num(SPI_MEDHA0_MUX_IN1) \
	gpio_name_to_num(SPI_MEDHA1_MUX_IN1) \
	...
	gpio_name_to_num(MEDHA1_HBM_CATTRIP_MMC_LVC33_R_ALARM)
#define name_gpio6	\
	gpio_name_to_num(Reserve_GPIO60) \
	gpio_name_to_num(Reserve_GPIO61) \
	gpio_name_to_num(QSPI_CPLD_SEL_1) \
	gpio_name_to_num(NC_SPI_MEDHA0_CRM_MUX_IN1) \
	gpio_name_to_num(NC_SPI_MEDHA1_CRM_MUX_IN1) \
...
#define name_gpioA	\
	gpio_name_to_num(MEDHA0_CURRENT_SENSE_0_LS_LVC33_R) \
	gpio_name_to_num(MEDHA0_CURRENT_SENSE_1_LS_LVC33_R) \
...
#define name_gpioF	\
	...
	gpio_name_to_num(SMB_MEDHA0_CRM_MMC_LVC33_ALERT_N) \
	gpio_name_to_num(SMB_MEDHA1_CRM_MMC_LVC33_ALERT_N)
