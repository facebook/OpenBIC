...
power_good_status power_good_status_table[] = {
	...
	{ PWRGD_U677, 2, VR_PWRGD_PIN_READING_6_REG, "PWRGD_U677" },
	{ PWRGD_U678, 1, VR_PWRGD_PIN_READING_6_REG, "PWRGD_U678" },
	{ PWRGD_U682, 0, VR_PWRGD_PIN_READING_6_REG, "PWRGD_U682" },
};
