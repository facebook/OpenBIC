...
power_sequence power_sequence_on_table[] = {
	...
	{ 43, HAMSA_VDDHRXTX_PCIE_ON_REG, "HAMSA_VDDHRXTX_PCIE_ON_REG", 0x00 },
	{ 44, PVDD1P5_ON_REG, "OWL_E/W_PVDD1P5_ON_REG", 0x00 },
...
power_sequence power_sequence_off_table[] = {
	{ 0, PVDD1P5_DOWN_REG, "OWL_E/W_PVDD1P5_DOWN_REG", 0x00 },
