...
static const hamsa_pcie_item_t hamsa_pcie_list[HAMSA_PCIE_MAX_ID] = {
	{ HAMSA_PCIE0, "HAMSA_PCIE0_PERST_B_PLD_N", CPLD_PERST_DELAY_0_REG, 0 },
	{ HAMSA_PCIE1, "HAMSA_PCIE1_PERST_B_PLD_N", CPLD_PERST_DELAY_1_REG, 4 },
	{ HAMSA_PCIE2, "HAMSA_PCIE2_PERST_B_PLD_N", CPLD_PERST_DELAY_2_REG, 8 },
	{ HAMSA_PCIE3, "HAMSA_PCIE3_PERST_B_PLD_N", CPLD_PERST_DELAY_3_REG, 12 },
};
