...
GPIO_CFG plat_gpio_cfg[] = {
	...
	/** Group D: 24-31 **/
	{ CHIP_GPIO, 24, ENABLE, DISABLE, GPIO_INPUT, GPIO_LOW,  PUSH_PULL, GPIO_INT_EDGE_RISING, ISR_VR_PWR_FAULT },
	...
	{ CHIP_GPIO, 44, ENABLE, DISABLE, GPIO_INPUT, GPIO_HIGH, OPEN_DRAIN, GPIO_INT_EDGE_RISING, ISR_WF_BIC_READY },
