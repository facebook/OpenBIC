...
SDR_Full_sensor plat_sdr_table[] = {
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P3V3, // sensor number
	...
	// SQ52205_01 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD01, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD01, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD01, // sensor number
	...
	// SQ52205_02 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD02, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD02, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD02, // sensor number
	...
	// SQ52205_03 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD03, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD03, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD03, // sensor number
	...
	// SQ52205_04 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD04, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD04, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD04, // sensor number
	...
	// SQ52205_05 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD05, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD05, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD05, // sensor number
	...
	// SQ52205_06 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD06, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD06, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD06, // sensor number
	...
	// SQ52205_07 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD07, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD07, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD07, // sensor number
	...
	// SQ52205_08 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD08, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD08, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD08, // sensor number
	...
	// SQ52205_09 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD09, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD09, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD09, // sensor number
	...
	// SQ52205_10 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD10, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD10, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD10, // sensor number
	...
	// SQ52205_11 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD11, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD11, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD11, // sensor number
	...
	// SQ52205_12 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD12, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD12, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD12, // sensor number
	...
	// SQ52205_13 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD13, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD13, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD13, // sensor number
	...
	// SQ52205_14 SDR
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_AUX_CARD14, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P12V_AUX_CARD14, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P12V_AUX_CARD14, // sensor number
