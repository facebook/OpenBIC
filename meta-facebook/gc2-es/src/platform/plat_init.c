...
SCU_CFG scu_cfg[] = {
	...
	// If not rework host console route uart1(HOST) <-> uart2, need to disable dts uart2 and plat_init.c need to setup register offset: 0x7e78909c to value: 0x00190021
	//{ 0x7e78909c, 0x00190021 },
