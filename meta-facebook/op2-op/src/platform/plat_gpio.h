...
#define OPB_name_gpioB \
	gpio_name_to_num(OPB_WRGD_P12V_E1S_3_R) \
...
#define OPB_name_gpioE \
	...
	gpio_name_to_num(OPB_E1S_0_POWER_EN) \
	gpio_name_to_num(OPB_E1S_1_POWER_EN) \
	gpio_name_to_num(OPB_E1S_2_POWER_EN) \
	gpio_name_to_num(OPB_E1S_3_POWER_EN) \
	gpio_name_to_num(OPB_E1S_4_POWER_EN)
...
#define name_gpioP \
	...
	gpio_name_to_num(BIC_EXP_ID) \
	gpio_name_to_num(BIC_BOARD_ID)
...
enum _OPA_GPIO_NUMS_ {
	OPA_name_gpioA OPA_name_gpioB OPA_name_gpioC OPA_name_gpioD OPA_name_gpioE OPA_name_gpioF
		OPA_name_gpioG OPA_name_gpioH name_gpioH name_gpioI name_gpioJ name_gpioK name_gpioL
			name_gpioM name_gpioN name_gpioO name_gpioP name_gpioQ name_gpioR name_gpioS
				name_gpioT name_gpioU
};

enum _OPB_GPIO_NUMS_ {
	OPB_name_gpioA OPB_name_gpioB OPB_name_gpioC OPB_name_gpioD OPB_name_gpioE OPB_name_gpioF
		OPB_name_gpioG OPB_name_gpioH
};
