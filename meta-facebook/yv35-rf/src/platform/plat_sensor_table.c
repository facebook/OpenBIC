...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_VOL_ASIC_1V8, sensor_dev_ast_adc, ADC_PORT7, NONE, NONE, stby_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_VOL_PVPP_AB, sensor_dev_ast_adc, ADC_PORT13, NONE, NONE, dc_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_VOL_PVPP_CD, sensor_dev_ast_adc, ADC_PORT12, NONE, NONE, dc_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_VOL_PVTT_AB, sensor_dev_ast_adc, ADC_PORT11, NONE, NONE, dc_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_VOL_PVTT_CD, sensor_dev_ast_adc, ADC_PORT10, NONE, NONE, dc_access, 1, 1,
	  SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },

	// INA233
	{ SENSOR_NUM_VOL_STBY12V, sensor_dev_ina233, I2C_BUS1, INA233_12V_ADDR, SMBUS_VOL_CMD,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_ina233_read, NULL, NULL, NULL, &ina233_init_args[0] },
	{ SENSOR_NUM_VOL_STBY3V3, sensor_dev_ina233, I2C_BUS1, INA233_3V3_ADDR, SMBUS_VOL_CMD,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0, SENSOR_INIT_STATUS,
	  pre_ina233_read, NULL, NULL, NULL, &ina233_init_args[1] },
	...
	{ SENSOR_NUM_TEMP_VR0V9A, sensor_dev_isl69254iraz_t, I2C_BUS10, VR_A0V9_ADDR,
	  SMBUS_TEMP_CMD, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0,
	...
	{ SENSOR_NUM_VOL_VRVDDQAB, sensor_dev_isl69254iraz_t, I2C_BUS10, VR_VDDQAB_ADDR,
	  SMBUS_VOL_CMD, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0,
	  SENSOR_INIT_STATUS, pre_isl69254iraz_t_read, &isl69254iraz_t_pre_read_args[1], NULL, NULL,
	  NULL },
	...
	{ SENSOR_NUM_CUR_VRVDDQAB, sensor_dev_isl69254iraz_t, I2C_BUS10, VR_VDDQAB_ADDR,
	  SMBUS_CUR_CMD, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0,
	  SENSOR_INIT_STATUS, pre_isl69254iraz_t_read, &isl69254iraz_t_pre_read_args[1], NULL, NULL,
	  NULL },
	...
	{ SENSOR_NUM_PWR_VRVDDQAB, sensor_dev_isl69254iraz_t, I2C_BUS10, VR_VDDQAB_ADDR,
	  SMBUS_PWR_CMD, vr_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, 0,
	  SENSOR_INIT_STATUS, pre_isl69254iraz_t_read, &isl69254iraz_t_pre_read_args[1], NULL, NULL,
	  NULL },
