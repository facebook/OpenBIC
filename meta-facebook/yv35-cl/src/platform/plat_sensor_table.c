...
sensor_cfg plat_sensor_config[] = {
	...
	// DIMM PMIC power
	{ SENSOR_NUM_PWR_DIMMA0_PMIC, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A0_A4_ADDR,
	  DIMM_PMIC_SWA_PWR, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_DIMMA2_PMIC, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A2_A6_ADDR,
	  DIMM_PMIC_SWA_PWR, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_DIMMA3_PMIC, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A3_A7_ADDR,
	  DIMM_PMIC_SWA_PWR, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_DIMMA4_PMIC, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A0_A4_ADDR,
	  DIMM_PMIC_SWA_PWR, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_DIMMA6_PMIC, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A2_A6_ADDR,
	  DIMM_PMIC_SWA_PWR, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
	{ SENSOR_NUM_PWR_DIMMA7_PMIC, sensor_dev_i3c_dimm, I3C_BUS4, PMIC_A3_A7_ADDR,
	  DIMM_PMIC_SWA_PWR, post_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,
	  ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, NULL },
};
...
bool pal_is_time_to_poll(uint8_t sensor_num, int poll_time)
{
	...
	LOG_ERR("can't find sensor 0x%x last accest time", sensor_num);
	return true;
}
