...
SDR_Full_sensor dpv2_sdr_table[] = {
	...
	{
		// DPV2_2_HSM Temperature (Marvell only)
		0x00,
		0x00, // record ID
		IPMI_SDR_VER_15, // SDR ver
		IPMI_SDR_FULL_SENSOR, // record type
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_DPV2_HSM, // sensor number
	...
	{
		// DPV2_2_HSM OCTEON Temperature (Marvell only)
		0x00,
		0x00, // record ID
		IPMI_SDR_VER_15, // SDR ver
		IPMI_SDR_FULL_SENSOR, // record type
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_HSM_SOC, // sensor number
