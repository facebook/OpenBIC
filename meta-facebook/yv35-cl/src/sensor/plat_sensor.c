...
snr_cfg plat_sensor_config[] = {
  ...
  pre_hook_fn, pre_hook_args, post_hook_fn, post_hook_args, init_arg */
	...
	{ SENSOR_NUM_TEMP_SSD0, sensor_dev_nvme, i2c_bus2, SSD0_addr, SSD0_offset, post_access, 0,
	  0, 0, SNR_INIT_STATUS, pre_nvme_read, &mux_conf_addr_0xe2[1], NULL, NULL, NULL },
	...
	{ SENSOR_NUM_TEMP_CPU_MARGIN, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CPU_MARGIN, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL,
	  post_cpu_margin_read, NULL, NULL },
	{ SENSOR_NUM_TEMP_CPU_TJMAX, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CPU_TJMAX, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_DIMM_A, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CHANNEL0_DIMM0, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_DIMM_C, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CHANNEL2_DIMM0, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_DIMM_D, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CHANNEL3_DIMM0, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_DIMM_E, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CHANNEL4_DIMM0, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_DIMM_G, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CHANNEL6_DIMM0, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_DIMM_H, sensor_dev_intel_peci, NONE, CPU_PECI_addr,
	  PECI_TEMP_CHANNEL7_DIMM0, post_access, 0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	...
	{ SENSOR_NUM_VOL_STBY12V, sensor_dev_ast_adc, adc_port0, NONE, NONE, stby_access, 667, 100,
	  0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL, &adc_asd_init_args[0] },
	...
	// ME
	{ SENSOR_NUM_TEMP_PCH, sensor_dev_pch, i2c_bus3, PCH_addr, PCH_TEMP_SNR_NUM, post_access, 0,
	...
	{ SENSOR_NUM_CUR_HSCOUT, sensor_dev_adm1278, i2c_bus2, HSC_addr, HSC_CUR_CMD, stby_access,
	  0, 0, 0, SNR_INIT_STATUS, NULL, NULL, NULL, NULL, &adm1278_init_args[0] },
