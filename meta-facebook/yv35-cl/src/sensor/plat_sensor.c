...
sensor_cfg class1_mp5990_sensor_config_table[] = {
	...
	{ SENSOR_NUM_TEMP_HSC, sensor_dev_mp5990, i2c_bus2, CLASS1_MPS_MP5990_ADDR,
	  PMBUS_READ_TEMPERATURE_1, stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL,
	  NULL, &mp5990_init_args[0] },
	{ SENSOR_NUM_VOL_HSCIN, sensor_dev_mp5990, i2c_bus2, CLASS1_MPS_MP5990_ADDR, PMBUS_READ_VIN,
	  stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &mp5990_init_args[0] },
	{ SENSOR_NUM_CUR_HSCOUT, sensor_dev_mp5990, i2c_bus2, CLASS1_MPS_MP5990_ADDR,
	  PMBUS_READ_IOUT, stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &mp5990_init_args[0] },
	{ SENSOR_NUM_PWR_HSCIN, sensor_dev_mp5990, i2c_bus2, CLASS1_MPS_MP5990_ADDR, PMBUS_READ_PIN,
	  stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &mp5990_init_args[0] },
};
...
sensor_cfg class1_adm1278_sensor_config_table[] = {
	/* number,                  type,       port,      address,      offset,
	   access check arg0, arg1, cache, cache_status, mux_address, mux_offset,
	   pre_sensor_read_fn, pre_sensor_read_args, post_sensor_read_fn, post_sensor_read_fn  */
	{ SENSOR_NUM_TEMP_HSC, sensor_dev_adm1278, i2c_bus2, CLASS1_ADI_ADM1278_ADDR,
	  PMBUS_READ_TEMPERATURE_1, stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL,
	  NULL, &adm1278_init_args[0] },
	{ SENSOR_NUM_VOL_HSCIN, sensor_dev_adm1278, i2c_bus2, CLASS1_ADI_ADM1278_ADDR,
	  PMBUS_READ_VIN, stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adm1278_init_args[0] },
	{ SENSOR_NUM_CUR_HSCOUT, sensor_dev_adm1278, i2c_bus2, CLASS1_ADI_ADM1278_ADDR,
	  PMBUS_READ_IOUT, stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adm1278_init_args[0] },
	{ SENSOR_NUM_PWR_HSCIN, sensor_dev_adm1278, i2c_bus2, CLASS1_ADI_ADM1278_ADDR,
	  PMBUS_READ_PIN, stby_access, 0, 0, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adm1278_init_args[0] },
};
