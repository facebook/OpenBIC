...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_PWR_CPU, sensor_dev_apml_mailbox, I2C_BUS14, APML_ADDR, SBRMI_MAILBOX_PKGPWR,
	  ...
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &apml_mailbox_init_args[16] },
