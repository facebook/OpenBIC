...
#define SITV3_THRESHOLD_UNIT 0.001
...
void cmd_set_sensor_threshold(const struct shell *shell, size_t argc, char **argv)
{
	...
	threshold_value = (float)value *
			  SITV3_THRESHOLD_UNIT; // If user want to send 3.3V, "value" will be 3300
...
SHELL_CMD_REGISTER(sensor_threshold, &sub_sensor_threshold_cmds, "threshold commands for sitv3",
		   NULL);
