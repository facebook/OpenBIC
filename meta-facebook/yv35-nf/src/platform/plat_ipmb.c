...
IPMB_config pal_IPMB_config_table[] = {
	// index, interface, channel, bus, channel_target_address, enable_status,
	// self_address, rx_thread_name, tx_thread_name
	{ GL_BIC_IPMB_IDX, I2C_IF, GL_BIC_IPMB, IPMB_GL_BIC_BUS, GL_BIC_I2C_ADDRESS, ENABLE,
	  SELF_I2C_ADDRESS, "RX_GL_BIC_IPMB_TASK", "TX_GL_BIC_IPMB_TASK" },
